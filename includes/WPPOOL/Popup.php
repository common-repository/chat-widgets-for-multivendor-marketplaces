    ...
    <div class="_wppool-popup-modal">
        ...
        <div class="_wppool-popup-modal-footer">
            ...
            <div class="_wppool-popup-countdown">
                <span class="_wppool-popup-countdown-text"><?php echo __('Deal Ends In', 'cwmm'); ?></span>
                <div class="_wppool-popup-countdown-time">
                    <div>
                        <span data-counter="days">00</span>
                        <span><?php echo __('Days', 'cwmm'); ?></span>
                    </div>
                    <span>:</span>
                    <div>
                        <span data-counter="hours">00</span>
                        <span><?php echo __('Hours', 'cwmm'); ?></span>
                    </div>
                    <span>:</span>
                    <div>
                        <span data-counter="minutes">00</span>
                        <span><?php echo __('Minutes', 'cwmm'); ?></span>
                    </div>
                    <span>:</span>
                    <div>
                        <span data-counter="seconds">00</span>
                        <span><?php echo __('Seconds', 'cwmm'); ?></span>
                    </div>
                </div>
            </div>

            <!-- button  -->
            <a class="_wppool-popup-button" href=""><?php echo __('Upgrade to Pro', 'cwmm'); ?></a>
        </div>
