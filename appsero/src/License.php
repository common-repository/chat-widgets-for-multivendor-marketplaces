        ...
        <div class="wrap appsero-license-settings-wrapper">
            ...
            <div class="appsero-license-settings appsero-license-section">
                ...
                <div class="appsero-license-details">
                    <p>Activate <strong>Chat Widgets</strong> by your license key to get professional support and automatic update from your WordPress dashboard.</p>
                    <form method="post" action="<?php $this->formActionUrl(); ?>" novalidate="novalidate" spellcheck="false">
                        ...
                        <div class="license-input-fields">
                            <div class="license-input-key">
                                ...
                                <input type="text" value="<?php echo $this->get_input_license_value($action, $license); ?>" placeholder="Enter your license key to activate" name="license_key" <?php echo ('deactive' == $action) ? 'readonly="readonly"' : ''; ?> />
                            </div>
